...
- **Figure 3:** *Comparison of grey squirrel density in existing strongholds under low, moderate and high pine marten suppression scenarios.*
  ![](images/Xray.png)

- **Figure 4:** *Stronghold Analysis, investigating how prioritised habitat composition, core area and grey squirrel density changes under suppression scenarios.*
  ![](images/graph.png)
...
- [Full dissertation (PDF)](FINAL_SUBMISSION.pdf)
- [Anonymous GitHub repository with code and data](https://github.com/MaxLarner/spatial_prioritisation)
